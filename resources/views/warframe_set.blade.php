    ...
    <div id="app" class="text-center">
        ...
        @if($loggedIn)
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                ...
                <br>
            <button v-if="modifyBtn" class="btn btn-primary" @click="deleteSet">Törlés</button>
        @else 
            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Összeállítás módosítása</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" v-if="modifyBtn" @click="modifySet">Módosítás</button>
                        <button type="button" class="btn btn-primary" v-else @click="saveSet">Mentés</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-5 bg-light box">
            <div style="align-items: center; justify-content: center;" class="flexbox">
                <div>
                    ...
                    <div id="holder0" class="bg-info text-center mb-1 box card-holder"
                ...
                <div>
                    ...
                    <div id="holder1" class="bg-info text-center mb-1 box card-holder"
                ...
                <div style="align-items: center; justify-content: center;" class="flexbox">
                    @for($i = 0; $i < 8; $i++)
                        <div>
                            ...
                            <div id="holder{{$i+2}}" class="bg-info text-center mb-1 box card-holder"
